...
public class LoginDAO {
    ...
    //Ottieni i valori dallo schema "login" nel database dato il suo id
    ...
    //Inserisce nello schema "login" i dati relativi all'utente
    ...
    //Aggiorna nello schema "login" i dati relativi all'utente
    ...
    //Rimuove dallo schema "login" i dati relativi all'utente dato il suo id
